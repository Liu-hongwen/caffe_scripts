...
sys.path.append('/home/prmct/workspace/pva-faster-rcnn-1228/caffe-fast-rcnn/python')
...
if __name__ == '__main__':
    ...
    work_root = '/home/prmct/Program/detection/pva/voc_0712plus/'
    model_def = work_root + 'faster_rcnn_train_test_ft_rcnn_only_plus_comp.prototxt'
    model_weights = work_root + 'PVA9.1_ImgNet_COCO_VOC0712plus.caffemodel'
