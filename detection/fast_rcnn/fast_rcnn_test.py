...
from fast_rcnn_utils import Timer, bbox_transform_inv, clip_boxes, im_list_to_blob, py_cpu_nms
import cPickle
import os
...
def apply_nms(all_boxes, thresh):
    ...
    for cls_ind in xrange(num_classes):
        for im_ind in xrange(num_images):
            ...
            if dets == []:
                continue
            # CPU NMS is much faster_rcnn than GPU NMS when the number of boxes
