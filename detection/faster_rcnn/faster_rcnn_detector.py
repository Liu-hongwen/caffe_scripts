...
if __name__ == '__main__':
    ...
    work_root = '/home/prmct/Program/detection/faster_rcnn/voc_vgg16/'
    model_def = work_root + 'faster_rcnn_test.prototxt'
    model_weights = work_root + 'VGG16_faster_rcnn_final.caffemodel'
