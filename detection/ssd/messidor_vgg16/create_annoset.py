...
caffe_ssd_root = '/home/prmct/workspace/caffe-ssd-0103'

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Create AnnotatedDatum database")
    parser.add_argument("--root", default="/home/prmct/Database/diabetic/messidor1_clear",
                        help="The root directory which contains the images and annotations.")
    parser.add_argument("--listfile", default='/home/prmct/Program/detection/ssd/messidor_vgg16/train_ssd.txt',
                        help="The file which contains image paths and annotation info.")
    parser.add_argument("--outdir", default="/home/prmct/Program/detection/ssd/messidor_vgg16/messidor_train_lmdb",
    ...
    parser.add_argument("--label-map-file", default="/home/prmct/Program/detection/ssd/messidor_vgg16/labelmap_messidor.prototxt",
    ...
    parser.add_argument("--resize-height", default=961, type=int,
                        help="Height images are resized to.")
    parser.add_argument("--resize-width", default=961, type=int,
    ...
    if anno_type == "detection":
        cmd = "{}/build/tools/convert_annoset" \
              ...
              " --gray={}" \
              " {} {} {}" \
            .format(caffe_ssd_root, anno_type, label_type, label_map_file, check_label,
        ...
        cmd = "{}/build/tools/convert_annoset" \
              ...
              " --gray={}" \
              " {} {} {}" \
            .format(caffe_ssd_root, anno_type, min_dim, max_dim, resize_height,
